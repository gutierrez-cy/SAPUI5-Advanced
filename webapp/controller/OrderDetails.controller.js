...
sap.ui.define([
    ...
    function _onObjectMatched(oEvent) {
        ...
        this.onClearSignature();//Se limpia la firma cuando se cambia depedido

        this.getView().bindElement({
            path: "/Orders(" + oEvent.getParameter("arguments").OrderID + ")",//OrderID del manifest
            model: "odataNorthwind", //modelo del manifest
            events: { //Por si se refresca la pagina (sin pasar por el index) y el modelo aun no esta cargado
        ...
        if (objContext) {//Por si se refresca la pagina (sin pasar por el index) y el modelo aun no esta cargado
    ...
    function _readSignature(orderId, employeeId) {
        ...
        //Leer la imagen de la firma del odata
        this.getView().getModel("incidenceModel").read("/SignatureSet(OrderId='" + orderId
            ...
            success: function (data) {
                ...
                if (data.MediaContent !== "") {
                    signature.setSignature("data:image/png;base64," + data.MediaContent);//se pasa la firma al 
                }
            }.bind(this),
            error: function (data) {
        ...
        //Se muestran los fiheros guardados en el odata
    ...
    return Controller.extend("logaligroup.employees.controller.OrderDetails", {
        ...
        onInit: function () {
            ...
            oRouter.getRoute("RouteOrderDetails").attachPatternMatched(_onObjectMatched, this); //RouteOrderDetails ruta definida en el manifest
        },
        ...
        factoryOrderDetails: function (listId, oContext) {
            ...
            contextObject.Currency = "EUR";//Se añade, ya que el modelo no existe
        ...
        onSaveSignature: function (oEvent) {
            ...
            if (!signature.isFill()) {//No Tenemos firma
                MessageBox.error(oResourceBundle.getText("fillSignature"));
            } else {//Si tenemos firma
                signaturePng = signature.getSignature().replace("data:image/png;base64,", "");//Solo nos quedamos con el code base64
        ...
        //lógica que añade en la cabecera de la llamada al servicio OData el parámetro SLUG 
        ...
        onFileChange: function (oEvent) {
            ...
            let oCustomerHeaderToken = new sap.m.UploadCollectionParameter({
                name: "x-csrf-token",
                value: this.getView().getModel("incidenceModel").getSecurityToken()//Se recupera el token que el odata devuelve
            });
