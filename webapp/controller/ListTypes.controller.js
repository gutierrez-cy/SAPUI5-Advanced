...
sap.ui.define([
    ...
    function (Controller) {
        ...
        return Controller.extend("logaligroup.lists.controller.ListTypes", {
            onInit: function () {
                //Cargar modelo en la vista desde fichero local
            ...
            onShowSelectedRows: function () {
                ...
                var i18nModel = this.getView().getModel("i18n").getResourceBundle(); //acceso a los textos del i18n
            ...
            onDeleteSelectedRows: function () {
                ...
                if (selectedItems.length === 0) {
                    ...
                    var products = model.getProperty("/Products"); //Devuelve los productos que hay en el modelo json "Products"
            ...
            onDeleteRow: function(oEvent){
                ...
                model.refresh(); //actualizar modelo en la interfaz de usuario
            }
        });
    });
